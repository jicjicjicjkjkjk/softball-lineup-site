...
export default function App() {
  ...
  function runOptimizeAll() {
    if (!optimizerBatchGames.length) return
    const confirmed = window.confirm('Optimize all selected games? This can overwrite unlocked lineup choices.')
    if (!confirmed) return
    ...
    orderedGames.forEach((game) => {
      ...
      const availableIds = (saved.availablePlayerIds || activePlayerIds()).map(pk)
      ...
      <div className="stack">
        <div className="card">
          ...
          <p className="small-note">
            “Refresh from Database” simply reloads the latest players, games, lineups, priorities, and attendance from Supabase.
          </p>
        </div>
                ...
                <tr key={game.id}>
                  ...
                  <td className="center-cell narrow-cell">
                    <input
                      ...
                      onChange={(e) => updateGameField(game.id, 'game_order', Number(e.target.value))}
                    />
                  </td>
