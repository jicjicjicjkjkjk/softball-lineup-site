...
export default function AdminPage({
  ...
  async function updateField(row, field, value) {
    ...
    await updateAppOption(row.id, {
      [field]: field === 'sort_order' ? (value === '' ? 999 : Number(value)) : value,
    })
  ...
  function renderSection(title, rows, form, setForm, itemLabel) {
    return (
      <div className="card">
        ...
        <button onClick={() => submitForm(form, setForm)}>Add {itemLabel}</button>
        ...
        <div className="row-between wrap-row">
          <div>
            ...
            <div className="small-note">
              Manage players and reusable dropdown options.
            </div>
          </div>
